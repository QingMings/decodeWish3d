...
;
    ...
    case DisplayMode[HeightmapWireframe]:
      {
        displayMode = DisplayMode[HeightmapWireframe];
 ...
 * @return {?}
 */
LSJMomentumParam[prototype][getMomentumSpeed] = function(local$$63930) {
  if (local$$63930 & LSMomentumFlag[MOMENTUM_ROLL]) {
    return this[dRotateAngle];
  }
  if (local$$63930 & LSMomentumFlag[MOMENTUM_PITCH]) {
    return this[dDeltaPitch];
  }
  if (local$$63930 & LSMomentumFlag[MOMENTUM_ZOOM]) {
...
LSJMomentumParam[prototype][start] = function(local$$63977) {
  if (local$$63977 & LSMomentumFlag[MOMENTUM_ROLL]) {
    /** @type {boolean} */
    this[bMomentumRoll] = true;
  }
  if (local$$63977 & LSMomentumFlag[MOMENTUM_PITCH]) {
    /** @type {boolean} */
    this[bMomentumPitch] = true;
  }
  if (local$$63977 & LSMomentumFlag[MOMENTUM_ZOOM]) {
    /** @type {boolean} */
...
LSJMomentumParam[prototype][stop] = function(local$$64027) {
  if (local$$64027 & LSMomentumFlag[MOMENTUM_ROLL]) {
    /** @type {boolean} */
    this[bMomentumRoll] = false;
    /** @type {number} */
    this[dRotateAngle] = 0;
  }
  if (local$$64027 & LSMomentumFlag[MOMENTUM_PITCH]) {
    /** @type {boolean} */
    this[bMomentumPitch] = false;
    /** @type {number} */
    this[dDeltaPitch] = 0;
  }
  if (local$$64027 & LSMomentumFlag[MOMENTUM_ZOOM]) {
    /** @type {boolean} */
    this[bMomentumZoom] = false;
    /** @type {number} */
    this[dZoomRadio] = 0;
...
LSJInertiaParam[prototype][start] = function(local$$64255) {
  if (local$$64255 & LSInertiaFlag[INERTIA_PAN]) {
    /** @type {boolean} */
    this[bPanInertia] = true;
  }
  if (local$$64255 & LSInertiaFlag[INERTIA_ROLL]) {
    /** @type {boolean} */
    this[bRollInteria] = true;
  }
  if (local$$64255 & LSInertiaFlag[INERTIA_PITCH]) {
    /** @type {boolean} */
    this[bPitchInteria] = true;
  }
  if (local$$64255 & LSInertiaFlag[INERTIA_ZOOM]) {
    /** @type {boolean} */
    this[bZoomInteria] = true;
  }
};
/**
 * @param {?} local$$64318
...
LSJInertiaParam[prototype][stop] = function(local$$64318) {
  if (local$$64318 & LSInertiaFlag[INERTIA_PAN]) {
    /** @type {boolean} */
    this[bPanInertia] = false;
    /** @type {number} */
    this[nCurPanTime] = 0;
  ...
  if (local$$64318 & LSInertiaFlag[INERTIA_ROLL]) {
    /** @type {boolean} */
    this[bRollInteria] = false;
    /** @type {number} */
    this[nCurRollTime] = 0;
    /** @type {number} */
    this[dDeltaRollAngle] = 0;
  }
  if (local$$64318 & LSInertiaFlag[INERTIA_PITCH]) {
    /** @type {boolean} */
    this[bPitchInteria] = false;
    /** @type {number} */
    this[nCurPitchTime] = 0;
  ...
  if (local$$64318 & LSMomentumFlag[INERTIA_ZOOM]) {
    /** @type {boolean} */
    this[bZoomInteria] = false;
    /** @type {number} */
    this[nCurZoomTime] = 0;
    /** @type {number} */
    this[dDeltaZoomRatio] = 0;
...
LSJRulerDistance = function() {
  this[renderLine] = undefined;
  this[renderPoints] = undefined;
  this[renderMarker] = undefined;
  this[geometryMaker] = undefined;
  this[geometryMakerV] = undefined;
  this[geometryMakerH] = undefined;
  this[lineSegMaterial] = undefined;
...
LSJRulerDistance[prototype][update] = function(local$$64690) {
  if (this[point3ds][length] == 2) {
    ...
    local$$64806[computeLineDistances]();
    this[lineSegMaterial] = new THREE.LineDashedMaterial({
      color : 65280,
      dashSize : .5,
      gapSize : .5,
      linewidth : 2
    });
    this[LineSegments] = new THREE.LineSegments(local$$64806, this[lineSegMaterial]);
    ...
    this[geometryMaker] = new LSJGeoMarker;
    var local$$65148 = new LSJMarkerStyle;
    /** @type {number} */
    local$$65148[iconSize] = 25;
    var local$$65160 = local$$65148[getTextStyle]();
    local$$65160[setFontName](Arial);
    local$$65160[getFillColor]()[setRGB](1, 1, 1);
    local$$65160[setStrokeWidth](20);
    this[geometryMaker][setStyle](local$$65148);
    local$$65010 = local$$64739[clone]()[sub](local$$64732)[length]();
    this[geometryMaker][setName](local$$65010[toFixed](2) + 米);
    this[geometryMaker][setPosition](local$$64732[x] + (local$$64739[x] - local$$64732[x]) / 2, local$$64732[y] + (local$$64739[y] - local$$64732[y]) / 2, local$$64732[z] + (local$$64739[z] - local$$64732[z]) / 2);
    var local$$65274 = new LSJTextSprite;
    local$$65274[setBorderColor]({
      r : 0,
      g : 0,
      b : 0,
      a : .8
    });
    local$$65274[setBackgroundColor]({
      r : 0,
      g : 0,
      b : 0,
      a : .3
    });
    local$$65274[setText](local$$65010[toFixed](2) + 米);
    /** @type {boolean} */
    ...
    this[geometryMakerV][setName](local$$65497[length]()[toFixed](2) + 米);
    this[geometryMakerV][setPosition](local$$64743[x] + local$$65497[x] / 2, local$$64743[y] + local$$65497[y] / 2, local$$64743[z] + local$$65497[z] / 2);
    var local$$65586 = new LSJTextSprite;
    local$$65586[setBorderColor]({
      r : 0,
      g : 0,
      b : 0,
      a : .8
    });
    local$$65586[setBackgroundColor]({
      r : 0,
      g : 0,
      b : 0,
      a : .3
    });
    local$$65586[setText](local$$65497[length]()[toFixed](2) + 米);
    /** @type {boolean} */
    ...
    this[edgeLabels][push](local$$65586);
    this[meshGroup][add](local$$65586);
    this[geometryMakerH] = new LSJGeoMarker;
    var local$$65749 = new LSJMarkerStyle;
    /** @type {number} */
    local$$65749[iconSize] = 30;
    var local$$65761 = local$$65749[getTextStyle]();
    local$$65761[setFontName](Arial);
    local$$65761[getFillColor]()[setRGB](1, 1, 1);
    local$$65761[setStrokeWidth](20);
    this[geometryMakerH][setStyle](local$$65749);
    if (local$$64732[z] < local$$64739[z]) {
      local$$65497 = local$$64739[clone]()[sub](local$$64743);
    } else {
      local$$65497 = local$$64732[clone]()[sub](local$$64743);
    }
    this[geometryMakerH][setName](local$$65497[length]()[toFixed](2) + 米);
    this[geometryMakerH][setPosition](local$$64743[x] + local$$65497[x] / 2, local$$64743[y] + local$$65497[y] / 2, local$$64743[z] + local$$65497[z] / 2);
    var local$$65883 = new LSJTextSprite;
    local$$65883[setBorderColor]({
      r : 0,
      g : 0,
      b : 0,
      a : .8
    });
    local$$65883[setBackgroundColor]({
      r : 0,
      g : 0,
      b : 0,
      a : .3
    });
    local$$65883[setText](local$$65497[length]()[toFixed](2) + 米);
    /** @type {boolean} */
    ...
    this[edgeLabels][push](local$$65883);
...
LSJRulerDistance[prototype][render] = function(local$$66066) {
  if (this[bUpdate]) {
    this[update](local$$66066[getScene]());
  }
  if (this[lineSegMaterial] != undefined) {
    ...
    this[lineSegMaterial][setValues]({
  ...
  /** @type {number} */
  var local$$66264 = 0;
  for (; local$$66264 < this[edgeLabels][length]; local$$66264++) {
    var local$$66279 = this[edgeLabels][local$$66264];
...
(function() {
  ...
  function local$$66411(local$$66412) {
     ...
     * @return {undefined}
     */
    this[calPhiAndThetaAngle] = function() {
      var local$$66535 = (new THREE.Quaternion)[setFromUnitVectors](this[object][up], new THREE.Vector3(0, 1, 0));
     ...
     * @return {undefined}
     */
    this[rotateLeft] = function(local$$66641) {
      /** @type {number} */
     ...
     * @return {undefined}
     */
    this[rotateUp] = function(local$$66653) {
      /** @type {number} */
     ...
     * @return {undefined}
     */
    this[pan] = function(local$$66768, local$$66769, local$$66770, local$$66771) {
      if (local$$66483[object] instanceof THREE[PerspectiveCamera]) {
        ...
        local$$66483[panLeft](2 * local$$66768 * local$$66805 / local$$66771);
        local$$66483[panUp](2 * local$$66769 * local$$66805 / local$$66771);
      } else {
        if (local$$66483[object] instanceof THREE[OrthographicCamera]) {
          local$$66483[panLeft](local$$66768 * (local$$66483[object][right] - local$$66483[object][left]) / local$$66770);
          local$$66483[panUp](local$$66769 * (local$$66483[object][top] - local$$66483[object][bottom]) / local$$66771);
        } else {
     ...
     * @return {undefined}
     */
    this[dollyIn] = function(local$$66913) {
      if (local$$66483[object] instanceof THREE[PerspectiveCamera]) {
        /** @type {number} */
        local$$66501 = local$$66501 / local$$66913;
      } else {
        if (local$$66483[object] instanceof THREE[OrthographicCamera]) {
          local$$66483[object][zoom] = Math[max](this[minZoom], Math[min](this[maxZoom], this[object][zoom] * local$$66913));
     ...
     * @return {undefined}
     */
    this[dollyOut] = function(local$$66992) {
      if (local$$66483[object] instanceof THREE[PerspectiveCamera]) {
        /** @type {number} */
        local$$66501 = local$$66501 * local$$66992;
      } else {
        if (local$$66483[object] instanceof THREE[OrthographicCamera]) {
          local$$66483[object][zoom] = Math[max](this[minZoom], Math[min](this[maxZoom], this[object][zoom] / local$$66992));
          local$$66483[object][updateProjectionMatrix]();
          /** @type {boolean} */
          local$$66512 = true;
        } else {
    ...
    this[update] = function() {
      ...
      var local$$67090 = (new THREE.Quaternion)[setFromUnitVectors](local$$66412[up], new THREE.Vector3(0, 1, 0));
      ...
      return function() {
        ...
        local$$66489 = Math[max](this[minAzimuthAngle], Math[min](this[maxAzimuthAngle], local$$66489));
        local$$66492 = Math[max](this[minPolarAngle], Math[min](this[maxPolarAngle], local$$66492));
        /** @type {number} */
        var local$$67179 = local$$67074[length]() * local$$66501;
        local$$67179 = Math[max](this[minDistance], Math[min](this[maxDistance], local$$67179));
        ...
        local$$67267[applyAxisAngle](local$$67274, local$$66492);
        if (local$$67267[z] < 0) {
          /** @type {number} */
          this[object][up][z] = -1;
        ...
        if (local$$66512 || local$$67104[distanceToSquared](this[object][position]) > local$$66486 || 8 * (1 - local$$67108[dot](this[object][quaternion])) > local$$66486) {
   ...
   * @return {undefined}
   */
  THREE[OrbitControls] = function(local$$67451, local$$67452) {
    /**
    ...
    function local$$67454(local$$67455, local$$67456) {
      ...
      local$$67475[pan](local$$67455, local$$67456, local$$67473[clientWidth], local$$67473[clientHeight]);
    }
    /**
     * @return {?}
     */
    function local$$67489() {
      return 2 * Math[PI] / 60 / 60 * local$$67458[autoRotateSpeed];
    }
    /**
     * @return {?}
     */
    function local$$67507() {
      return Math[pow](.95, local$$67458[zoomSpeed]);
    }
    /**
     * @param {?} local$$67521
     * @return {undefined}
    ...
    function local$$67520(local$$67521) {
      ...
      if (local$$67521[button] === local$$67458[mouseButtons][ORBIT]) {
        if (local$$67458[enableRotate] === false) {
          return;
        }
        local$$67556 = local$$67557[ROTATE];
        local$$67563[set](local$$67521[clientX], local$$67521[clientY]);
      } else {
        if (local$$67521[button] === local$$67458[mouseButtons][ZOOM]) {
          if (local$$67458[enablePan] === false) {
            return;
          }
          local$$67556 = local$$67557[PAN];
          local$$67600[set](local$$67521[clientX], local$$67521[clientY]);
        } else {
          if (local$$67521[button] === local$$67458[mouseButtons][PAN]) {
            if (local$$67458[enablePan] === false) {
              return;
            }
            local$$67556 = local$$67557[PAN];
      ...
      if (local$$67556 !== local$$67557[NONE]) {
    ...
    function local$$67664(local$$67687) {
      ...
      if (local$$67556 === local$$67557[ROTATE]) {
        if (local$$67458[enableRotate] === false) {
          return;
        }
        local$$67732[set](local$$67687[clientX], local$$67687[clientY]);
        local$$67744[subVectors](local$$67732, local$$67563);
        local$$67475[rotateLeft](2 * Math[PI] * local$$67744[x] / local$$67717[clientWidth] * local$$67458[rotateSpeed]);
        local$$67475[rotateUp](2 * Math[PI] * local$$67744[y] / local$$67717[clientHeight] * local$$67458[rotateSpeed]);
        local$$67563[copy](local$$67732);
      } else {
        if (local$$67556 === local$$67557[DOLLY]) {
          ...
          if (local$$67825[y] > 0) {
            local$$67475[dollyIn](local$$67507());
          } else {
            if (local$$67825[y] < 0) {
              local$$67475[dollyOut](local$$67507());
            }
          }
          local$$67829[copy](local$$67813);
        } else {
          if (local$$67556 === local$$67557[PAN]) {
            if (local$$67458[enablePan] === false) {
              return;
            }
    ...
    function local$$67969(local$$67970) {
      if (local$$67458[enabled] === false || local$$67458[enableZoom] === false || local$$67556 !== local$$67557[NONE]) {
        return;
      }
    ...
    function local$$68069(local$$68070) {
      if (local$$67458[enabled] === false || local$$67458[enableKeys] === false || local$$67458[enablePan] === false) {
        return;
      }
      switch(local$$68070[keyCode]) {
        case local$$67458[keys][UP]:
          local$$67454(0, local$$67458[keyPanSpeed]);
          local$$67458[update]();
          break;
        case local$$67458[keys][BOTTOM]:
          local$$67454(0, -local$$67458[keyPanSpeed]);
          local$$67458[update]();
          break;
        case local$$67458[keys][LEFT]:
          local$$67454(local$$67458[keyPanSpeed], 0);
          local$$67458[update]();
          break;
        case local$$67458[keys][RIGHT]:
          local$$67454(-local$$67458[keyPanSpeed], 0);
          local$$67458[update]();
          break;
      }
    ...
    function local$$68181(local$$68182) {
      ...
      switch(local$$68182[touches][length]) {
        case 1:
          ...
          local$$67556 = local$$67557[TOUCH_ROTATE];
          local$$67563[set](local$$68182[touches][0][pageX], local$$68182[touches][0][pageY]);
          break;
        case 2:
          if (local$$67458[enableZoom] === false) {
            return;
          ...
          /** @type {number} */
          var local$$68265 = local$$68182[touches][0][pageX] - local$$68182[touches][1][pageX];
          /** @type {number} */
          var local$$68284 = local$$68182[touches][0][pageY] - local$$68182[touches][1][pageY];
          var local$$68293 = Math[sqrt](local$$68265 * local$$68265 + local$$68284 * local$$68284);
          local$$67829[set](0, local$$68293);
          local$$68301[set](local$$68182[touches][0][pageX], local$$68182[touches][0][pageY]);
          local$$68323[set](local$$68182[touches][1][pageX], local$$68182[touches][1][pageY]);
          if (local$$67458[enablePan] === false) {
            return;
          }
          local$$67600[set](local$$68182[touches][0][pageX], local$$68182[touches][0][pageY]);
          break;
        default:
          local$$67556 = local$$67557[NONE];
      }
    ...
    function local$$68400(local$$68401) {
      ...
      switch(local$$68401[touches][length]) {
        case 1:
          ...
          if (local$$67556 !== local$$67557[TOUCH_ROTATE]) {
            return;
          }
          local$$67732[set](local$$68401[touches][0][pageX], local$$68401[touches][0][pageY]);
          local$$67744[subVectors](local$$67732, local$$67563);
          local$$67475[rotateLeft](2 * Math[PI] * local$$67744[x] / local$$68436[clientWidth] * local$$67458[rotateSpeed]);
          local$$67475[rotateUp](2 * Math[PI] * local$$67744[y] / local$$68436[clientHeight] * local$$67458[rotateSpeed]);
          local$$67563[copy](local$$67732);
          local$$67458[update]();
          break;
        case 2:
          ...
          /** @type {number} */
          var local$$68572 = local$$68401[touches][0][pageX] - local$$68401[touches][1][pageX];
          /** @type {number} */
          var local$$68591 = local$$68401[touches][0][pageY] - local$$68401[touches][1][pageY];
          ...
          local$$68604[set](local$$68401[touches][0][pageX], local$$68401[touches][0][pageY]);
          local$$68608[set](local$$68401[touches][1][pageX], local$$68401[touches][1][pageY]);
          local$$68604[subVectors](local$$68604, local$$68301);
          local$$68608[subVectors](local$$68608, local$$68323);
          local$$68301[set](local$$68401[touches][0][pageX], local$$68401[touches][0][pageY]);
          local$$68323[set](local$$68401[touches][1][pageX], local$$68401[touches][1][pageY]);
          local$$67813[set](0, local$$68600);
          local$$67825[subVectors](local$$67813, local$$67829);
          local$$67879[set](local$$68401[touches][0][pageX], local$$68401[touches][0][pageY]);
          local$$67829[copy](local$$67813);
          if (Math[abs](local$$67825[y]) > 2) {
            local$$67556 = local$$67557[TOUCH_DOLLY];
            if (local$$67825[y] > 0) {
              local$$67475[dollyOut](local$$67507());
            } else {
              if (local$$67825[y] < 0) {
            ...
            if (local$$68604[length]() > 2 && local$$68608[length]() > 2) {
              ...
              local$$67556 = local$$67557[TOUCH_PAN];
              local$$67891[subVectors](local$$67879, local$$67600);
              local$$67454(local$$67891[x], local$$67891[y]);
            }
          }
     ...
     */
    this[getPolarAngle] = function() {
      return local$$67475[getPolarAngle]();
    };
    /**
     * @return {?}
     */
    this[getAzimuthalAngle] = function() {
      return local$$67475[getAzimuthalAngle]();
    };
    /** @type {boolean} */
    this[enabled] = true;
    ...
    var local$$67556 = local$$67557[NONE];
     ...
     */
    this[update] = function() {
      if (this[autoRotate] && local$$67556 === local$$67557[NONE]) {
        local$$67475[rotateLeft](local$$67489());
      }
    ...
    this[dispose] = function() {
      ...
      document[removeEventListener](mousemove, local$$67664, false);
      document[removeEventListener](mouseup, local$$67673, false);
      window[removeEventListener](keydown, local$$68069, false);
    };
    ...
    window[addEventListener](keydown, local$$68069, false);
    this[update]();
  };
  ...
  Object[defineProperties](THREE[OrbitControls][prototype], {
    ...
    target : {
      ...
      set : function(local$$69501) {
        ...
        this[constraint][target][copy](local$$69501);
        this[constraint][calPhiAndThetaAngle]();
      }
    },
    minDistance : {
      get : function() {
      ...
      set : function(local$$69542) {
        this[constraint][minDistance] = local$$69542;
      }
    },
    maxDistance : {
      get : function() {
      ...
      set : function(local$$69565) {
        this[constraint][maxDistance] = local$$69565;
      }
    },
    minZoom : {
      get : function() {
      ...
      set : function(local$$69588) {
        this[constraint][minZoom] = local$$69588;
      }
    },
    maxZoom : {
      get : function() {
      ...
      set : function(local$$69611) {
        this[constraint][maxZoom] = local$$69611;
      }
    },
    minPolarAngle : {
      get : function() {
      ...
      set : function(local$$69634) {
        this[constraint][minPolarAngle] = local$$69634;
      }
    },
    maxPolarAngle : {
      get : function() {
      ...
      set : function(local$$69657) {
        this[constraint][maxPolarAngle] = local$$69657;
      }
    },
    minAzimuthAngle : {
      get : function() {
      ...
      set : function(local$$69680) {
        this[constraint][minAzimuthAngle] = local$$69680;
      }
    },
    maxAzimuthAngle : {
      get : function() {
      ...
      set : function(local$$69703) {
        this[constraint][maxAzimuthAngle] = local$$69703;
      }
    },
    enableDamping : {
      get : function() {
      ...
      set : function(local$$69726) {
        this[constraint][enableDamping] = local$$69726;
      }
    },
    dampingFactor : {
      get : function() {
      ...
      set : function(local$$69749) {
        this[constraint][dampingFactor] = local$$69749;
      }
    },
    noZoom : {
      get : function() {
    ...
    staticMoving : {
      ...
      set : function(local$$69916) {
        console[warn](THREE.OrbitControls: .staticMoving has been deprecated. Use .enableDamping instead.);
        /** @type {boolean} */
        this[constraint][enableDamping] = !local$$69916;
      }
    },
    dynamicDampingFactor : {
      ...
      set : function(local$$69955) {
        console[warn](THREE.OrbitControls: .dynamicDampingFactor has been renamed. Use .dampingFactor instead.);
        this[constraint][dampingFactor] = local$$69955;
      }
    }
  });
})();
...
LSJTextSprite = function(local$$69985) {
  ...
  this[sprite] = new THREE.Sprite(local$$70024);
 ...
 * @return {undefined}
 */
LSJTextSprite[prototype][setText] = function(local$$70124) {
 ...
 * @return {?}
 */
LSJTextSprite[prototype][getSprite] = function() {
  return this[sprite];
};
/**
 * @param {?} local$$70167
 * @return {undefined}
 */
LSJTextSprite[prototype][setTextColor] = function(local$$70167) {
  this[textColor] = local$$70167;
  this[update]();
};
/**
 * @param {?} local$$70189
 * @return {undefined}
 */
LSJTextSprite[prototype][setBorderColor] = function(local$$70189) {
  this[borderColor] = local$$70189;
  this[update]();
};
/**
 * @param {?} local$$70211
 * @return {undefined}
 */
LSJTextSprite[prototype][setBackgroundColor] = function(local$$70211) {
...
LSJTextSprite[prototype][update] = function() {
  ...
  local$$70248[font] = Bold  + this[fontsize] + px  + this[fontface];
  var local$$70275 = local$$70248[measureText](this[text]);
  var local$$70280 = local$$70275[width];
  /** @type {number} */
  var local$$70283 = 5;
  var local$$70294 = 2 * local$$70283 + local$$70280 + 2 * this[borderThickness];
  /** @type {number} */
  var local$$70307 = this[fontsize] * 1.4 + 2 * this[borderThickness];
  ...
  local$$70248[strokeStyle] = rgba( + this[borderColor][r] + , + this[borderColor][g] + , + this[borderColor][b] + , + this[borderColor][a] + );
  local$$70248[lineWidth] = this[borderThickness];
  this[roundRect](local$$70248, this[borderThickness] / 2, this[borderThickness] / 2, local$$70280 + this[borderThickness] + 2 * local$$70283, this[fontsize] * 1.4 + this[borderThickness], 6);
  local$$70248[strokeStyle] = rgba(0, 0, 0, 1.0);
  local$$70248[strokeText](this[text], this[borderThickness] + local$$70283, this[fontsize] + this[borderThickness]);
  local$$70248[fillStyle] = rgba( + this[textColor][r] + , + this[textColor][g] + , + this[textColor][b] + , + this[textColor][a] + );
  local$$70248[fillText](this[text], this[borderThickness] + local$$70283, this[fontsize] + this[borderThickness]);
  ...
  this[sprite][material][map] = local$$70587;
  this[sprite][scale][set](local$$70294 * .01, local$$70307 * .01, 1);
};
/**
 * @return {?}
 */
 ...
 * @return {undefined}
 */
LSJTextSprite[prototype][roundRect] = function(local$$70669, local$$70670, local$$70671, local$$70672, local$$70673, local$$70674) {
  local$$70669[beginPath]();
  local$$70669[moveTo](local$$70670 + local$$70674, local$$70671);
  local$$70669[lineTo](local$$70670 + local$$70672 - local$$70674, local$$70671);
  local$$70669[quadraticCurveTo](local$$70670 + local$$70672, local$$70671, local$$70670 + local$$70672, local$$70671 + local$$70674);
  local$$70669[lineTo](local$$70670 + local$$70672, local$$70671 + local$$70673 - local$$70674);
  local$$70669[quadraticCurveTo](local$$70670 + local$$70672, local$$70671 + local$$70673, local$$70670 + local$$70672 - local$$70674, local$$70671 + local$$70673);
  local$$70669[lineTo](local$$70670 + local$$70674, local$$70671 + local$$70673);
  local$$70669[quadraticCurveTo](local$$70670, local$$70671 + local$$70673, local$$70670, local$$70671 + local$$70673 - local$$70674);
  local$$70669[lineTo](local$$70670, local$$70671 + local$$70674);
  local$$70669[quadraticCurveTo](local$$70670, local$$70671, local$$70670 + local$$70674, local$$70671);
 ...
 * @return {undefined}
 */
LSJModelLODNode[prototype][setMatrixWorldNeedsUpdate] = function(local$$71186) {
  this[matrixWorldNeedsUpdate] = local$$71186;
  var local$$71199 = this[children][length];
  /** @type {number} */
  var local$$71202 = 0;
  for (; local$$71202 < local$$71199; local$$71202++) {
    var local$$71211 = this[children][local$$71202];
    local$$71211[setMatrixWorldNeedsUpdate](local$$71186);
  }
};
/**
 * @param {?} local$$71230
...
LSJModelLODNode[prototype][loadTexture] = function(local$$71282, local$$71283, local$$71284) {
  ...
  if (local$$71354 == .pvr) {
    local$$71282[texture] = this[loadPVRTexture](local$$71282, local$$71283, local$$71284);
  } else {
    if (local$$71354 == .dds) {
      local$$71282[texture] = this[loadDDSTexture](local$$71282, local$$71283, local$$71284);
    } else {
      /**
       * @param {?} local$$71382
       * @return {undefined}
      ...
      if (local$$71437 !== null) {
        ...
        local$$71437[load](local$$71282[imgUrl], function(local$$71474) {
          ...
          local$$71300[minFilter] = THREE[LinearMipMapLinearFilter];
 ...
 * @return {?}
 */
LSJModelLODNode[prototype][loadPVRTexture] = function(local$$71592, local$$71593, local$$71594) {
  /**
   * @return {undefined}
   */
 ...
 * @return {?}
 */
LSJModelLODNode[prototype][loadDDSTexture] = function(local$$71755, local$$71756, local$$71757) {
  /**
   * @return {undefined}
   */
  ...
  local$$71757 = function(local$$71799) {
    ...
    local$$71799[wrapS] = THREE[MirroredRepeatWrapping];
    local$$71799[wrapT] = THREE[MirroredRepeatWrapping];
    local$$71799[minFilter] = THREE[LinearMipMapNearestFilter];
    local$$71799[magFilter] = THREE[LinearMipMapNearestFilter];
    /** @type {number} */
    local$$71799[anisotropy] = 4;
    if (local$$71755[bImgBlobUrl]) {
      window[URL][revokeObjectURL](local$$71755[imgUrl]);
    }
    local$$71755[imgUrl] = ;
...
LSJModelLODNode[prototype][netLoad] = function() {
  if (this[model][curHttpRequestNum] > this[model][maxHttpRequestNum]) {
    return;
  }
  /**
   * @param {?} local$$71936
  ...
  var local$$71955 = function(local$$71936) {
    ...
    local$$71938[model][curHttpRequestNum]--;
  };
  this[setLoadStatus](LSELoadStatus.LS_NET_LOADING);
  /** @type {!XMLHttpRequest} */
  ...
  this[model][curHttpRequestNum]++;
  local$$71964[send](null);
  /**
   * @param {?} local$$72001
   * @return {undefined}
   */
  local$$71964[onprogress] = function(local$$72001) {
...
LSJModelLODNode[prototype][load] = function() {
  if (this[model][curNodeParseThreadNum] > this[model][maxNodeParseThreadNum]) {
    return;
  }
  if (this[dataBuffer] == null) {
    this[setLoadStatus](LSELoadStatus.LS_LOADED);
  ...
  this[model][curNodeParseThreadNum]++;
  /** @type {!Worker} */
  var local$$72142 = new Worker(script/lsjworker/LSJLBMLoadWorker.js);
  /**
   * @param {?} local$$72147
   * @return {undefined}
   */
  local$$72142[onmessage] = function(local$$72147) {
    ...
    if (local$$72152 != null && local$$72152 != undefined) {
      ...
      var local$$72187 = local$$72152[arryImages][length];
      /** @type {number} */
      var local$$72190 = 0;
      for (; local$$72190 < local$$72187; local$$72190++) {
        var local$$72196 = new LSJModelNodeTexture;
        var local$$72202 = local$$72152[arryImages][local$$72190];
        local$$72196[bTransparent] = local$$72202[bTransparent];
        ...
        local$$72129[arryTextures][push](local$$72196);
      }
      ...
      for (; local$$72190 < local$$72321; local$$72190++) {
        ...
        if (local$$72333[diffuse][0] != 0 || local$$72333[diffuse][1] != 0 || local$$72333[diffuse][2] != 0) {
          local$$72340[color] = (new THREE.Color)[setRGB](local$$72333[diffuse][0] / 255, local$$72333[diffuse][1] / 255, local$$72333[diffuse][2] / 255);
        }
        ...
        local$$72340[emission] = (new THREE.Color)[setRGB](local$$72333[emission][0] / 255, local$$72333[emission][1] / 255, local$$72333[emission][2] / 255);
        local$$72340[shininess] = local$$72333[shininess];
        if (local$$72333[diffuse][3] < 255) {
          /** @type {number} */
          local$$72340[opacity] = local$$72333[diffuse][3] / 255;
          /** @type {boolean} */
          local$$72340[transparent] = true;
        }
        var local$$72511 = local$$72333[imgUnits][length];
        /** @type {number} */
        var local$$72514 = 0;
        for (; local$$72514 < local$$72511; local$$72514++) {
          local$$72336[imgUnits][push](local$$72333[imgUnits][local$$72514]);
        }
        local$$72129[arryMaterials][push](local$$72336);
      }
      local$$72129[parse](local$$72152, local$$72129[arryTextures], local$$72129[arryMaterials], local$$72158);
    }
    /** @type {null} */
    local$$72152 = null;
    /** @type {null} */
    ...
    local$$72590[x] = local$$72129[root][model][getRotate]()[x];
    local$$72590[y] = local$$72129[root][model][getRotate]()[y];
    local$$72590[z] = local$$72129[root][model][getRotate]()[z];
    local$$72586[setFromEuler](local$$72590);
    local$$72582[compose](local$$72129[root][model][getPosition](), local$$72586, local$$72129[root][model][getScale]());
    local$$72129[root][bdSphere][applyMatrix4](local$$72582);
    local$$72129[root][bdBox][applyMatrix4](local$$72582);
    /** @type {boolean} */
    local$$72129[matrixWorldNeedsUpdate] = true;
    local$$72129[model][curNodeParseThreadNum]--;
  };
  /**
   * @param {?} local$$72726
   * @return {undefined}
...
LSJModelLODNode[prototype][parse] = function(local$$72781, local$$72782, local$$72783, local$$72784) {
  ...
  if (local$$72781[bdSphere][length] > 0) {
    ...
    LSJMath[expandSphere](this[model][rootNode][bdSphere], this[bdSphere]);
  }
  if (local$$72781[bdBox][length] > 0) {
    ...
    this[model][rootNode][bdBox][union](this[bdBox]);
  }
  ...
  for (; local$$73127 < local$$73124; local$$73127++) {
    ...
    if (local$$73136[verts] != null) {
      ...
      var local$$73282 = local$$73136[primitiveSets][length];
      /** @type {number} */
      var local$$73285 = -1;
      if (local$$73282 > 0) {
        local$$73145[setIndex](new THREE.BufferAttribute(local$$73136[primitiveSets][0][indices], 1));
        local$$73285 = local$$73136[primitiveSets][0][matIndex];
      }
      ...
      if (local$$73334 != null) {
        ...
        local$$73403 = local$$73334[imgUnits][length];
      }
      /** @type {number} */
      var local$$73427 = 0;
      for (; local$$73427 < local$$73403; local$$73427++) {
        var local$$73439 = local$$73334[imgUnits][local$$73427][imgIndex];
        if (local$$73439 >= 0 && local$$73439 < local$$72782[length]) {
          this[arryTextureUsed][push](local$$72782[local$$73439]);
          if (local$$73334[material][map] == null || local$$73334[material][map] === undefined) {
            ...
            if (local$$72782[local$$73439][bTransparent]) {
              /** @type {boolean} */
...
LSJModelLODNode[prototype][checkInFrustum] = function(local$$73584) {
  this[setInFrustumTestOk](false);
  var local$$73599 = this[model][getFrustum]();
  if (!this[bdSphere][empty]()) {
 ...
 * @return {?}
 */
LSJModelLODNode[prototype][isAllTextureLoaded] = function() {
  /** @type {number} */
  var local$$73727 = 0;
  var local$$73735 = this[arryTextureUsed][length];
  for (; local$$73727 < local$$73735; local$$73727++) {
    if (this[arryTextureUsed][local$$73727][status] != LSELoadStatus[LS_LOADED]) {
      return false;
    }
  }
  return true;
 ...
 * @return {?}
 */
LSJModelLODNode[prototype][hasLoadingTexture] = function() {
  /** @type {number} */
  var local$$73772 = 0;
  var local$$73780 = this[arryTextureUsed][length];
  for (; local$$73772 < local$$73780; local$$73772++) {
    if (this[arryTextureUsed][local$$73772][status] != LSELoadStatus[LS_UNLOAD] && this[arryTextureUsed][local$$73772][status] != LSELoadStatus[LS_LOADED]) {
      return true;
    }
  }
  return false;
...
LSJModelLODNode[prototype][unloadChildren] = function() {
  ...
  this[childRanges][splice](0, this[childRanges][length]);
  this[arryMaterialUsed][splice](0, this[arryMaterialUsed][length]);
  this[arryTextureUsed][splice](0, this[arryTextureUsed][length]);
  /** @type {number} */
  ...
  local$$73894 = this[arryTextures][length];
  /** @type {number} */
  local$$73886 = 0;
  for (; local$$73886 < local$$73894; local$$73886++) {
    var local$$74138 = this[arryTextures][local$$73886];
  ...
  this[arryTextures][splice](0, local$$73894);
  /** @type {boolean} */
  this[bHasGeometry] = false;
  /** @type {null} */
  this[dataBuffer] = null;
...
LSJModelLODNode[prototype][update] = function(local$$74306) {
  ...
  this[bNormalRendered] = false;
  {
    ...
    local$$74369[x] = this[root][model][getRotate]()[x];
    local$$74369[y] = this[root][model][getRotate]()[y];
    local$$74369[z] = this[root][model][getRotate]()[z];
    local$$74365[setFromEuler](local$$74369);
    local$$74361[compose](this[root][model][getPosition](), local$$74365, this[root][model][getScale]());
    ...
    for (; local$$74329 < local$$74326; local$$74329++) {
      ...
      if (local$$74486 && local$$74486 instanceof THREE[Mesh]) {
        local$$74486[scale][x] = this[root][model][scale][x];
        local$$74486[scale][y] = this[root][model][scale][y];
        local$$74486[scale][z] = this[root][model][scale][z];
        local$$74486[position][x] = this[root][model][getPosition]()[x];
        local$$74486[position][y] = this[root][model][getPosition]()[y];
        local$$74486[position][z] = this[root][model][getPosition]()[z];
        local$$74486[rotation][x] = this[root][model][rotate][x];
        local$$74486[rotation][y] = this[root][model][rotate][y];
        local$$74486[rotation][z] = this[root][model][rotate][z];
        /** @type {boolean} */
        local$$74486[matrixWorldNeedsUpdate] = true;
  ...
  this[setLastAccessTime](this[model][getLastAccessTime]());
  this[setLastAccessFrame](this[model][getLastAccessFrame]());
  if (this[strDataPath] != ) {
    if (this[getLoadStatus]() == LSELoadStatus[LS_UNLOAD]) {
      getScene()[curSendNode]++;
      this[netLoad]();
  ...
  if (this[childRanges][length] > 0) {
    if (this[enRangeMode] == LSERangeMode[RM_DISTANCE_FROM_EYE_POINT]) {
      if (!this[bdSphere][empty]()) {
        local$$74821 = LSJMath[computeDistFromEye](this[bdSphere][center], this[model][getModelViewMatrix]());
      }
    } else {
      if (this[enRangeMode] == LSERangeMode[RM_PIXEL_SIZE_ON_SCREEN]) {
        if (!this[bdSphere][empty]()) {
          local$$74821 = LSJMath[computeSpherePixelSize](this[bdSphere], this[model][getPixelSizeVector]());
        }
      }
    }
  }
  ...
  var local$$75045 = this[isAllTextureLoaded]();
  if (!this[bNormalRendered] && this[model][curTexRequestNum] < this[model][maxTexRequestNum]) {
    local$$74326 = this[arryTextureUsed][length];
    /** @type {number} */
    local$$74329 = 0;
    for (; local$$74329 < local$$74326; local$$74329++) {
      var local$$75083 = this[arryTextureUsed][local$$74329];
      if (local$$75083[status] == LSELoadStatus[LS_UNLOAD]) {
        this[loadTexture](local$$75083, this[model]);
      }
    }
  }
  if (local$$75045 && !this[bMap] || this[root][model][bUpadteMtl]) {
    /** @type {number} */
    local$$74329 = 0;
    for (; local$$74329 < this[arryMaterialUsed][length]; local$$74329++) {
      var local$$75138 = this[arryMaterialUsed][local$$74329];
      local$$75083 = this[arryTextureUsed][local$$74329];
      if (local$$75083 != undefined) {
        local$$75138[material][color] = (new THREE.Color)[setRGB](1, 1, 1);
      }
      if (this[root][model][bSelect]) {
...
LSJGeoModelLOD = function() {
  ...
  /** @type {number} */
  this[maxNodeCount] = 200;
  this[rootNode] = new LSJModelLODNode;
  this[rootNode][model] = this;
  this[rootNode][root] = this[rootNode];
  this[meshGroup][add](this[rootNode][meshGroup]);
 ...
 * @return {undefined}
 */
LSJGeoModelLOD[prototype][setModelPath] = function(local$$75567) {
  if (this[strModelPath] != local$$75567) {
    this[dispose]();
    var local$$75579 = new LSJModelLODNode;
    local$$75579[strDataPath] = local$$75567;
    this[rootNode][addNode](local$$75579);
    this[strModelPath] = local$$75567;
  }
};
/**
 * @return {?}
 */
LSJGeoModelLOD[prototype][getModelPath] = function() {
...
LSJGeoModelLOD[prototype][setPosition] = function(local$$75643, local$$75644, local$$75645) {
  ...
  this[rootNode][setMatrixWorldNeedsUpdate](true);
};
/**
 * @return {?}
 */
 ...
 * @return {undefined}
 */
LSJGeoModelLOD[prototype][setRotate] = function(local$$75711, local$$75712, local$$75713) {
 ...
 * @return {?}
 */
LSJGeoModelLOD[prototype][getRotate] = function() {
  return this[rotate];
};
/**
 * @param {?} local$$75779
 ...
 * @return {undefined}
 */
LSJGeoModelLOD[prototype][setScale] = function(local$$75779, local$$75780, local$$75781) {
 ...
 * @return {?}
 */
LSJGeoModelLOD[prototype][getScale] = function() {
  return this[scale];
};
/**
 * @param {?} local$$75847
 * @return {undefined}
 */
LSJGeoModelLOD[prototype][setSelect] = function(local$$75847) {
  if (this[bSelect] != local$$75847) {
    this[bSelect] = local$$75847;
    /** @type {boolean} */
    this[bUpadteMtl] = true;
  }
};
/**
 * @return {?}
 */
LSJGeoModelLOD[prototype][getBoundingBox] = function() {
  return this[rootNode][bdBox];
};
/**
 * @return {?}
 */
LSJGeoModelLOD[prototype][getBoundingSphere] = function() {
  return this[rootNode][bdSphere];
};
/**
 * @return {?}
 */
...
LSJGeoModelLOD[prototype][update] = function(local$$76328) {
  ...
  /** @type {number} */
  this[curLoadingNode] = 0;
  this[rootNode][update](local$$76328);
  if (this[nodeCount] > this[maxNodeCount]) {
    this[cleanRedundantNodes](this[rootNode]);
  }
};
/**
 * @param {?} local$$76391
...
LSJFeatureLayer[prototype][addSelectionObject] = function(local$$76507) {
  local$$76507[setSelect](true);
  this[selecttiongeometrys][push](local$$76507);
};
/**
 * @return {undefined}
 */
LSJFeatureLayer[prototype][releaseSelection] = function() {
  var local$$76540 = this[selecttiongeometrys][length];
  /** @type {number} */
  var local$$76543 = 0;
  for (; local$$76543 < local$$76540; local$$76543++) {
    var local$$76552 = this[selecttiongeometrys][local$$76543];
    if (local$$76552 != null) {
      local$$76552[setSelect](false);
    }
  }
};
/**
...
LSJFeatureLayer[prototype][setPath] = function(local$$76576) {
  ...
  local$$76594[load](local$$76576, function(local$$76599) {
    ...
    if (local$$76610 !== undefined) {
      ...
      var local$$76720 = local$$76610[Features];
      if (local$$76720 !== undefined) {
        ...
        for (; local$$76729 < local$$76726; local$$76729++) {
          ...
          if (local$$76735 !== undefined) {
            ...
            local$$76739[setName](local$$76735[Feature].Name);
            var local$$76763 = local$$76735[Feature][Model][Location][x];
            var local$$76777 = local$$76735[Feature][Model][Location][y];
            var local$$76791 = local$$76735[Feature][Model][Location][z];
            local$$76739[setPosition](local$$76763, local$$76777, local$$76791);
            local$$76739[layer] = local$$76590;
            var local$$76815 = local$$76735[Feature][Model][Link][href];
            local$$76739[setModelPath](LSJUtility[getAbsolutePath](LSJUtility[getDir](local$$76576), local$$76815));
 ...
 * @return {undefined}
 */
LSJPointCloudLayer[prototype][setPointSize] = function(local$$76957) {
  if (this[pointSize] !== local$$76957) {
    this[pointSize] = local$$76957;
  }
};
/**
 * @return {?}
 */
LSJPointCloudLayer[prototype][getPointSize] = function() {
 ...
 * @return {undefined}
 */
LSJPointCloudLayer[prototype][setPointSizing] = function(local$$76995) {
  if (this[sizeType] !== local$$76995) {
    this[sizeType] = local$$76995;
    if (local$$76995 === Fixed) {
      this[pointSizeType] = Potree[PointSizeType][FIXED];
    } else {
      if (local$$76995 === Attenuated) {
        this[pointSizeType] = Potree[PointSizeType][ATTENUATED];
      } else {
        if (local$$76995 === Adaptive) {
 ...
 * @return {?}
 */
LSJPointCloudLayer[prototype][getPointSizing] = function() {
 ...
 * @return {undefined}
 */
LSJPointCloudLayer[prototype][setQuality] = function(local$$77083) {
  var local$$77088 = this[quality];
  if (local$$77083 == Interpolation && !Potree[Features][SHADER_INTERPOLATION][isSupported]()) {
    this[quality] = Squares;
  } else {
    if (local$$77083 == Splats && !Potree[Features][SHADER_SPLATS][isSupported]()) {
      this[quality] = Squares;
    } else {
      this[quality] = local$$77083;
    }
  }
};
/**
 * @return {?}
 */
LSJPointCloudLayer[prototype][getQuality] = function() {
  return this[quality];
};
/**
 * @param {?} local$$77170
 * @return {undefined}
 */
LSJPointCloudLayer[prototype][setPointColorType] = function(local$$77170) {
  this[toMaterialID](local$$77170);
};
/**
 * @return {?}
 */
LSJPointCloudLayer[prototype][getPointColorType] = function() {
 ...
 * @return {undefined}
 */
LSJPointCloudLayer[prototype][toMaterialID] = function(local$$77206) {
  if (local$$77206 === RGB) {
 ...
 * @return {?}
 */
LSJPointCloudLayer[prototype][toMaterialName] = function(local$$77421) {
  if (local$$77421 === Potree[PointColorType][RGB]) {
    return RGB;
  } else {
    if (local$$77421 === Potree[PointColorType][COLOR]) {
      return Color;
    } else {
      if (local$$77421 === Potree[PointColorType][HEIGHT]) {
        return Elevation;
      } else {
        if (local$$77421 === Potree[PointColorType][INTENSITY]) {
          return Intensity;
        } else {
          if (local$$77421 === Potree[PointColorType][INTENSITY_GRADIENT]) {
            return Intensity Gradient;
          } else {
            if (local$$77421 === Potree[PointColorType][CLASSIFICATION]) {
              return Classification;
            } else {
              if (local$$77421 === Potree[PointColorType][RETURN_NUMBER]) {
                return Return Number;
              } else {
                if (local$$77421 === Potree[PointColorType][SOURCE]) {
                  return Source;
                } else {
                  if (local$$77421 === Potree[PointColorType][TREE_DEPTH]) {
                    return Tree Depth;
                  } else {
                    if (local$$77421 === Potree[PointColorType][POINT_INDEX]) {
                      return Point Index;
                    } else {
                      if (local$$77421 === Potree[PointColorType][NORMAL]) {
                        return Normal;
                      } else {
                        if (local$$77421 === Potree[PointColorType][PHONG]) {
                          return Phong;
                        }
                      }
                    }
 ...
 * @return {undefined}
 */
LSJPointCloudLayer[prototype][setHeightRange] = function(local$$77588, local$$77589) {
  if (this[heightMin] !== local$$77588 || this[heightMax] !== local$$77589) {
    this[heightMin] = local$$77588 || this[heightMin];
    this[heightMax] = local$$77589 || this[heightMax];
  }
};
/**
 * @return {?}
 */
LSJPointCloudLayer[prototype][getHeightRange] = function() {
  return {
    min : this[heightMin],
    max : this[heightMax]
  };
...
LSJPointCloudLayer[prototype][setPath] = function(local$$77664) {
  ...
  Potree[POCLoader][load](local$$77664, function(local$$77686) {
    local$$77678[pointcloud] = new Potree.PointCloudOctree(local$$77686);
    local$$77678[pointcloud][material][PointShape] = Potree[PointShape][CIRCLE];
    local$$77668[add](local$$77678[pointcloud]);
    local$$77668[updateMatrixWorld](true);
    local$$77678[boundingSphere] = local$$77678[pointcloud][boundingSphere][clone]()[applyMatrix4](local$$77678[pointcloud][matrixWorld]);
  });
};
/**
 * @param {?} local$$77766
...
LSJPointCloudLayer[prototype][render] = function(local$$77766) {
  if (this[pointcloud] != undefined) {
    ...
    this[pointcloud][material][opacity] = this[opacity];
    this[pointcloud][material][pointColorType] = this[pointColorType];
    this[pointcloud][material][pointSizeType] = this[pointSizeType];
    this[pointcloud][material][heightMin] = this[heightMin];
    this[pointcloud][material][heightMax] = this[heightMax];
    this[pointcloud][update](controlCamera, controlRender);
  }
};
/**
 * @param {?} local$$77873
 ...
 * @return {undefined}
 */
LSJGeoLabel[prototype][setVerticalOrign] = function(local$$77994) {
  this[verticalOrign] = local$$77994;
};
/**
 * @return {?}
 */
LSJGeoLabel[prototype][getVerticalOrign] = function() {
  return this[verticalOrign];
};
/**
 * @return {?}
 */
LSJGeoLabel[prototype][getHorizontalOrigin] = function() {
 ...
 * @return {undefined}
 */
LSJGeoLabel[prototype][setHorizontalOrigin] = function(local$$78041) {
 ...
 * @return {undefined}
 */
LSJGeoLabel[prototype][setLabelElement] = function(local$$78090) {
  this[element] = local$$78090;
  /** @type {boolean} */
  this[needUpdate] = true;
};
/**
...
LSJGeoLabel[prototype][update] = function() {
  ...
  html2canvas(this[element], {
    ...
    onrendered : function(local$$78175) {
      local$$78146[element][style][display] = none;
...
LSJGeoLabel[prototype][render] = function(local$$78479, local$$78480) {
  ...
  if (this[billboard] != undefined) {
    ...
    if (this[element] != undefined) {
      /** @type {number} */
      this[billboard][scale][x] = this[billboard][scale][y] = this[billboard][scale][z] = this[labelSize] * local$$78557;
      /** @type {number} */
      this[screenRect][left] = local$$78658;
      /** @type {number} */
      this[screenRect][bottom] = local$$78713;
      /** @type {number} */
      this[screenRect][top] = local$$78713 + this[labelSize] * local$$78560;
    }
    /** @type {number} */
